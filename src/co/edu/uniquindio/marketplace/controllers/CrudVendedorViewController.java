...
public class CrudVendedorViewController {
	...
	public boolean aceptarSolicitud(Vendedor vendedor, Vendedor solicitudSeleccionado) {
		return modelFactoryController.aceptarSolicitud(vendedor, solicitudSeleccionado);
	}

	public ArrayList<Vendedor> obtenerVendedoresAsociados(Vendedor vendedorPrincipal) {
		return modelFactoryController.obtenerVendedoresAsociados(vendedorPrincipal);
	}
